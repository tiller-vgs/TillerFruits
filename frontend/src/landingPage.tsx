...
const features = [
  {
    ...
    description: 'Last opp teksten din og få tilbakemelding fra klassekameratene dine basert på kriteriene læreren har satt.',
  },
  {
    title: 'Bli bedre av å vurdere',
    description: 'Når du vurderer andres tekster lærer du faktisk ganske mye selv også. Det er litt poenget.',
  },
  {
    title: 'Læreren bestemmer kriteriene',
    description: 'Læreren skriver inn hva dere skal vurdere hverandre på, så alle vet hva de skal se etter.',
  },
]
  ...
  return (
    <div className=" min-h-screen overflow-x-hidden">
      ...
      <div className="relative flex flex-col items-center justify-center min-h-[calc(100vh-65px)] px-6 text-center overflow-hidden">
        ...
        <span className="absolute top-[4%]  left-[3%]  text-5xl animate-float        pointer-events-none select-none opacity-25">🍋</span>
        <span className="absolute top-[8%]  left-[18%] text-3xl animate-float-slow   pointer-events-none select-none opacity-20">🍎</span>
        <span className="absolute top-[3%]  left-[35%] text-4xl animate-float        pointer-events-none select-none opacity-20">🍇</span>
        <span className="absolute top-[6%]  right-[28%] text-3xl animate-float-slow  pointer-events-none select-none opacity-15">🍓</span>
        <span className="absolute top-[5%]  right-[12%] text-5xl animate-float       pointer-events-none select-none opacity-25">🍊</span>
        <span className="absolute top-[2%]  right-[3%]  text-3xl animate-float-slow  pointer-events-none select-none opacity-20">🍍</span>

        <span className="absolute top-[20%] left-[2%]  text-4xl animate-float-slow   pointer-events-none select-none opacity-20">🍉</span>
        <span className="absolute top-[25%] left-[12%] text-3xl animate-float        pointer-events-none select-none opacity-15">🍑</span>
        <span className="absolute top-[22%] right-[4%]  text-4xl animate-float       pointer-events-none select-none opacity-20">🥭</span>
        <span className="absolute top-[30%] right-[14%] text-3xl animate-float-slow  pointer-events-none select-none opacity-15">🍒</span>

        <span className="absolute top-[45%] left-[4%]  text-3xl animate-float        pointer-events-none select-none opacity-20">🫐</span>
        <span className="absolute top-[50%] left-[15%] text-4xl animate-float-slow   pointer-events-none select-none opacity-15">🍈</span>
        <span className="absolute top-[48%] right-[5%]  text-3xl animate-float-slow  pointer-events-none select-none opacity-20">🍋</span>
        <span className="absolute top-[42%] right-[16%] text-4xl animate-float       pointer-events-none select-none opacity-15">🍎</span>

        <span className="absolute bottom-[28%] left-[6%]  text-4xl animate-float     pointer-events-none select-none opacity-20">🍊</span>
        <span className="absolute bottom-[22%] left-[20%] text-3xl animate-float-slow pointer-events-none select-none opacity-15">🍇</span>
        <span className="absolute bottom-[30%] right-[7%]  text-5xl animate-float    pointer-events-none select-none opacity-20">🍓</span>
        <span className="absolute bottom-[20%] right-[20%] text-3xl animate-float-slow pointer-events-none select-none opacity-15">🍑</span>

        <span className="absolute bottom-[8%] left-[4%]  text-3xl animate-float-slow  pointer-events-none select-none opacity-20">🍍</span>
        <span className="absolute bottom-[5%] left-[22%] text-4xl animate-float       pointer-events-none select-none opacity-15">🍒</span>
        <span className="absolute bottom-[10%] left-[40%] text-3xl animate-float-slow pointer-events-none select-none opacity-15">🥭</span>
        <span className="absolute bottom-[7%] right-[22%] text-4xl animate-float      pointer-events-none select-none opacity-20">🫐</span>
        <span className="absolute bottom-[4%] right-[5%]  text-5xl animate-float-slow pointer-events-none select-none opacity-25">🍉</span>
